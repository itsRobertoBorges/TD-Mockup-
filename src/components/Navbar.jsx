      ...
      <nav className="td-navbar" aria-label="Main navigation">
        <div className="td-navbar__left">
          ...
          <ul className="td-navbar__links">
            <li><Link to="/main-graphic">Personal</Link></li> 
            <li><Link to="/credit-card">Debit Cards</Link></li> {/* ✅ proper Link */}
            <li><a href="/services-graphic">Investing</a></li>
            <li><a href="/support-graphic">Support</a></li>
          </ul>
        </div>
